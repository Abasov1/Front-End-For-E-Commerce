                ...
                <div class="product-item__outer h-100 shadow-lg" >
                    <div class="product-item__inner p-md-3 row no-gutters">
                            ...
                            <div class="col col-lg-auto product-media-left">
                                <router-link :to="{name:'Product',params:{slug:pr.slug}}" class="max-width-150 d-block"><img class="img-fluid" :src="api+'images/products/'+pr.images[0].image" alt="Image Description"></router-link>
                            </div>
