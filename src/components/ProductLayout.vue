...
<template>
    <header id="header" class="u-header u-header-left-aligned-nav">
         <div class="u-header__section">
                         ...
                         <div class="topbar-right ml-auto">
                             <ul class="list-inline mb-0">
                                 ...
                                 <li class="list-inline-item mr-0 u-header-topbar__nav-item u-header-topbar__nav-item-border">
                                     ...
                                     <a id="sidebarNavToggler" href="javascript:;" role="button" class="u-header-topbar__nav-link" @click.prevent="showSidebar">
             ...
             <div v-if="route.name === 'Home' && categories" class="d-none d-xl-block container">
                    <div class="row">
                        <!-- Vertical Menu -->
                                    ...
                                    <div class="card border-0">
                                        ...
                                        <div id="basicsCollapseOne" class="collapse show vertical-menu"
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <div v-if="categories"   @mouseleave="[subcat = false,subsubcat = false]" style="width:300%;height:400px;">
...
watch(()=>store.state.user.language,()=>{
        if(categories.value && route.name === 'Home'){
            setCategory()
        }
})
const setCategory = () =>{
