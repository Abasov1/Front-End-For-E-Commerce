                            ...
                            <table class="table" cellspacing="0">
                                ...
                                <tbody>
                                    <tr v-if="products" v-for="wish in products.slice(0,sliceNumber)" :key="wish.id">
                                        ...
                                        <router-link :to="{name:'Product',params:{slug:wish.slug}}"><img class="img-fluid max-width-100 p-1 border border-color-1" :src="api+'images/products/'+wish.images[0].image" alt="Image Description"></router-link>
                                        </td>
