                            ...
                            <tbody >
                                <tr v-for="cr in or.products" :key="cr.id" class="">
                                    <td class="d-none d-md-table-cell">
                                        <router-link :to="{name:'Product',params:{slug:cr.slug}}"><img class="img-fluid max-width-100 p-1 border border-color-1" :src="api+'images/products/'+cr.images[0].image" alt="Image Description"></router-link>
                                    </td>
