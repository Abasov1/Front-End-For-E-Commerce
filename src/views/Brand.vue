                    ...
                    <div class="col-xl-9 col-wd-9gdot5">
                        ...
                        <nav class="d-md-flex justify-content-between align-items-center border-top pt-3" aria-label="Page navigation example">
                            ...
                            <ul class="pagination mb-0 pagination-shop justify-content-center justify-content-md-start">
                                ...
                                <li v-if="formData.page > 2" class="page-item"><a @click.prevent class="page-link" href="#">...</a></li>
                                ...
                                <li v-if="store.state.prs.pras.count - 2 > formData.page" class="page-item"><a @click.prevent class="page-link" href="#">...</a></li>
...
watch(()=>store.state.user.language,()=>{
    ...
    if(products.value && formData.brid){
        setPrName()
    }
