                ...
                <div class="mb-14">
                    <div class="row">
                        <div class="col-md-5 mb-4 mb-md-0">
                            <div class="d-flex justify-content-center align-items-center" style="min-width:100%;min-height:70%;">
                                <div class="js-slide d-flex justify-content-center align-items-center" style="min-width:100%;min-height:100%;">
                                    <img class="img-fluid d-flex justify-content-center"  style="min-width:300px;max-width:300px;" :src="api+'images/products/'+product.images[activeImage].image" alt="Image Description">
                                </div>
                            </div>
                            ...
                            <div style="position:relative;margin-top:10px; display:flex; align-items:center; margin-right:1rem;" :style="product.images.length < 5 ? 'justify-content:center;' : 'justify-content:space-between;'">
                                ...
                                <div v-for="n in product.images.length" :key="n" >
                                    <div class="js-slide" v-if="n - 1 > activePage -1 && n - 1 < activePage + 5" style="cursor: pointer;width:80px;display:inline-block;" :style="[activeImage === n - 1 ? 'border-bottom:solid orange;' : '']">
                                        <img @click="activeImage = n - 1" class="img-fluid" :src="api+'images/products/'+product.images[n - 1].image" alt="Image Description">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-4 mb-md-6 mb-lg-0">
                            <div class="mb-2">
                                <a @click.prevent href="#" class="font-size-12 text-gray-5 mb-2 d-inline-block">{{product.category.name}}</a>
                            ...
                            <div class="mb-2">
                                <div class="card p-5 border-width-2 border-color-1 borders-radius-17">
                                    ...
                                    <div v-if="!store.state.user.isLoggedIn" class="mb-2 pb-0dot5">
                                        <a @click.prevent="dejj" href="#" class="btn btn-block btn-primary-dark thoseWhoShallSuffer"><i class="bi bi-cart mr-2 font-size-15"></i>{{store.state.user.language.add_cart}}</a>
                                    </div>
                                    <div v-if="!store.state.user.isLoggedIn" class="mb-3">
                                        <a @click.prevent="dejj" href="#" class="btn btn-block btn-dark thoseWhoShallSuffer"><i class="bi bi-heart mr-2 font-size-15"></i>{{store.state.user.language.wishlist}}</a>
                                    </div>
                                    <div v-if="store.state.user.isLoggedIn" class="mb-2 pb-0dot5">
                                ...
                                <div v-if="product" v-for="rew in product.reviews" :key="rew.id" class="border-bottom border-color-1 pb-4 mb-4">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center text-secondary font-size-1 mb-2">
                                        <div class="text-warning text-ls-n2 font-size-16">
                                            ...
                                            <span v-if="rew.isBought === '1'" style="color:green;font-size:11px;"> - Bought this product</span>
...
watch(()=>store.state.user.language,()=>{
    ...
    if(store.state.prs.product && relatablyNoProduct.value){
        document.title = store.state.user.language.search_bar.no_result
        relatablyNoProduct.value = true
    }
